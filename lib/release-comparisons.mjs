...
export function buildReleaseComparison(options = {}) {
  ...
  return {
    ...
    methodology: {
      ...
      note: "Metric values are always shown when data exists. Findings require the listed sample and effect thresholds.",
    },
    samples: {
...
function buildVersionMetricSnapshot(cohort, events, funnelDefinitions) {
  ...
  return {
    ...
    events,
    sessions,
    sessionCount: Math.max(cleanInteger(cohort.sessionCount), sessions.length),
