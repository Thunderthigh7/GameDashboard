...
function createCustomEvents(random, sessions) {
  ...
  for (const session of sessions) {
    ...
    if (random() < (isCurrentRelease ? 0.34 : 0.08)) add(session, "item_purchased", 12, AREAS.shop, { product: ["Starter Pack", "Double Coins", "Revive"][index % 3], priceRobux: [99, 149, 49][index % 3] });
