...
Settings.RenderHeatmapInRoblox = true
Settings.HeatmapFolderName = "DashboardMovementHeatmap"
Settings.HeatmapPointSize = 4
Settings.MaxRenderedHeatmapPoints = 700
