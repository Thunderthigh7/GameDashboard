...
3. Click **RoAnalytics Installer**, then click **Connect & Install**.
4. The pairing request is auto-approved. The plugin installs automatically as soon as your website recognizes the connected experience.
...
The pairing expires after ten minutes. The website auto-approves the request and returns the install credential directly.
Regenerating the game's secret on the website also revokes plugin-issued install credentials.
